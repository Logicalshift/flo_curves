...
///
pub fn walk_curve_evenly<'a, Curve>(curve: Curve, distance: f64, max_error: f64) -> EvenWalkIterator<'a, Curve> 
where
    Curve: BezierCurve,
{
...
pub struct EvenWalkIterator<'a, Curve: BezierCurve> {
    ...
    /// Lifetime of a curve section
    lifetime: PhantomData<CurveSection<'a, Curve>>,
}
...
impl<'a, Curve: BezierCurve> EvenWalkIterator<'a, Curve> {
    ...
    ///
    pub fn vary_by<DistanceIter>(self, distance: DistanceIter) -> impl 'a + Iterator<Item=CurveSection<'a, Curve>>
    where
        DistanceIter: 'a + Iterator<Item=f64>,
    {
        VaryingWalkIterator {
            even_iterator:      self,
...
impl<'a, Curve> Iterator for EvenWalkIterator<'a, Curve> 
where
    Curve: 'a + BezierCurve
{
    type Item = CurveSection<'a, Curve>;
...
impl<'a, Curve, DistanceIter> Iterator for VaryingWalkIterator<'a, Curve, DistanceIter> 
where
    Curve: 'a + BezierCurve,
    DistanceIter: 'a + Iterator<Item=f64>,
{
