...
fn full_intersect_two_partially_overlapping_circles() {
    ...
    let intersection    = path_full_intersect::<SimpleBezierPath>(&vec![circle1], &vec![circle2], 0.1);
...
fn fintersect_two_fully_overlapping_circles() {
    ...
    let intersection    = path_intersect::<SimpleBezierPath>(&vec![circle1], &vec![circle2], 0.1);
