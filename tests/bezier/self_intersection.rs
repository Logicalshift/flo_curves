...
#[test]
fn narrow_loop() {
    let curve_with_loop     = Curve::from_points(Coord2(549.2899780273438, 889.4202270507813), (Coord2(553.4288330078125, 893.8638305664063), Coord2(542.5203247070313, 889.04931640625)), Coord2(548.051025390625, 891.1853637695313));
    let intersection_point  = find_self_intersection_point(&curve_with_loop, 0.01);
