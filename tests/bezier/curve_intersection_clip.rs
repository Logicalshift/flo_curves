...
fn find_intersection_on_straight_line_not_middle() {
    ...
    let curve1 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(0.0, 0.0), Coord2(13.0, 13.0)));
    let curve2 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(9.0, 1.0), Coord2(0.0, 10.0)));
...
fn find_intersection_on_straight_line_middle() {
    // Cross that intersects at (5.0, 5.0)
    let curve1 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(0.0, 0.0), Coord2(10.0, 10.0)));
    let curve2 =
...
fn find_intersection_on_straight_line_start() {
    ...
    let curve1 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(5.0, 5.0), Coord2(10.0, 10.0)));
    let curve2 =
...
fn find_intersection_on_straight_line_end_1() {
    // Intersection at the start of two curves
    let curve1 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(10.0, 10.0), Coord2(5.0, 5.0)));
    let curve2 =
...
fn find_intersection_on_straight_line_near_end() {
    // Intersection at the start of two curves
    let curve1 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(10.0, 10.0), Coord2(4.9, 5.1)));
    let curve2 =
        line::line_to_bezier::<_, bezier::Curve<_>>(&(Coord2(0.0, 10.0), Coord2(5.1, 4.9)));
...
fn find_intersections_on_curve() {
    ...
    //
    let curve1 = bezier::Curve::from_points(
        Coord2(10.0, 100.0),
        (Coord2(90.0, 30.0), Coord2(40.0, 140.0)),
        Coord2(220.0, 220.0),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(5.0, 150.0),
        (Coord2(180.0, 20.0), Coord2(80.0, 250.0)),
        Coord2(210.0, 190.0),
    );
...
fn intersections_with_nearby_curves_3() {
    let curve1 = bezier::Curve::from_points(
        Coord2(304.6919250488281, 880.6288452148438),
        (
            Coord2(304.2330017089844, 879.1104736328125),
            Coord2(301.8935546875, 878.1200561523438),
        ),
        Coord2(296.8869323730469, 873.9132690429688),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(301.61907958984375, 877.5440673828125),
        (
            Coord2(300.2510986328125, 876.6381225585938),
            Coord2(298.3997802734375, 875.2341918945313),
        ),
        Coord2(296.0204772949219, 873.1698608398438),
    );
...
fn intersections_with_nearby_curves_4() {
    let curve1 = bezier::Curve::from_points(
        Coord2(436.15716552734375, 869.3236083984375),
        (
            Coord2(444.5263671875, 869.2921752929688),
            Coord2(480.9628601074219, 854.3709106445313),
        ),
        Coord2(490.6786804199219, 849.5614624023438),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(462.5539855957031, 861.322021484375),
        (
            Coord2(462.4580078125, 861.4293823242188),
            Coord2(462.3710021972656, 861.5908813476563),
        ),
        Coord2(462.3448486328125, 861.8137817382813),
    );
...
fn intersection_curve_1() {
    let curve1 = bezier::Curve::from_points(
        Coord2(252.08901977539063, 676.4180908203125),
        (
            Coord2(244.0195770263672, 679.6658935546875),
            Coord2(244.11508178710938, 682.8816528320313),
        ),
        Coord2(244.31190490722656, 686.1041259765625),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(244.31190490722656, 686.1041259765625),
        (
            Coord2(250.65411376953125, 661.4817504882813),
            Coord2(255.51109313964844, 635.5418701171875),
        ),
        Coord2(265.2398376464844, 618.4223022460938),
    );
    ...
    assert!(
        curve1
            ...
            .distance_to(&curve2.point_at_pos(intersections[0].1))
            < 0.01
    );
    assert!(
        curve1
            .point_at_pos(intersections[1].0)
            .distance_to(&curve2.point_at_pos(intersections[1].1))
            < 0.01
    );
    ...
    assert!(
        curve2
            .point_at_pos(intersections[0].0)
            .distance_to(&curve1.point_at_pos(intersections[0].1))
            < 0.01
    );
    assert!(
        curve2
            .point_at_pos(intersections[1].0)
            .distance_to(&curve1.point_at_pos(intersections[1].1))
            < 0.01
    );
}
...
fn intersection_curve_2() {
    let curve1 = bezier::Curve::from_points(
        Coord2(248.42221069335938, 678.5138549804688),
        (
            Coord2(240.33773803710938, 703.49462890625),
            Coord2(246.20928955078125, 728.5226440429688),
        ),
        Coord2(258.2634582519531, 745.7745361328125),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(240.6450958251953, 688.1998901367188),
        (
            Coord2(248.51101684570313, 684.6644897460938),
            Coord2(248.41787719726563, 681.5728759765625),
        ),
        Coord2(248.42221069335938, 678.5138549804688),
    );
...
fn intersection_curve_3() {
    let curve1 = bezier::Curve::from_points(
        Coord2(377.8294677734375, 495.076904296875),
        (
            Coord2(380.0453796386719, 492.69927978515625),
            Coord2(381.98138427734375, 489.805419921875),
        ),
        Coord2(383.61865234375, 486.40106201171875),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(379.064697265625, 493.7556457519531),
        (
            Coord2(371.90069580078125, 491.9415588378906),
            Coord2(368.96783447265625, 493.451171875),
        ),
        Coord2(366.3587951660156, 494.5915832519531),
    );
...
fn intersection_curve_4() {
    ...
    let curve2 = bezier::Curve::from_points(
        Coord2(379.064697265625, 493.7556457519531),
        (
            Coord2(371.3619079589844, 493.8326110839844),
            Coord2(366.50872802734375, 495.2229919433594),
        ),
        Coord2(362.0657958984375, 496.14581298828125),
    );
...
fn intersection_curve_6() {
    let curve1 = bezier::Curve::from_points(
        Coord2(608.7642211914063, 855.5934448242188),
        (
            Coord2(608.6810302734375, 855.288330078125),
            Coord2(608.5828857421875, 855.0850830078125),
        ),
        Coord2(608.47265625, 855.011962890625),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(608.81689453125, 855.5904541015625),
        (
            Coord2(608.7009887695313, 855.386474609375),
            Coord2(608.5858154296875, 855.193115234375),
        ),
        Coord2(608.47265625, 855.011962890625),
    );
...
fn intersection_curve_7() {
    ...
    let curve1 = bezier::Curve::from_points(
        Coord2(602.1428833007813, 859.0895385742188),
        (
            Coord2(607.4638061523438, 858.4710693359375),
            Coord2(614.4444580078125, 855.14404296875),
        ),
        Coord2(608.3931884765625, 855.6187133789063),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(608.3871459960938, 864.779541015625),
        (
            Coord2(609.6311645507813, 860.09716796875),
            Coord2(608.9767456054688, 852.512939453125),
        ),
        Coord2(607.8642578125, 855.7709350585938),
    );
    let curve3 = bezier::Curve::from_points(
        Coord2(611.2799682617188, 862.292236328125),
        (
            Coord2(610.607666015625, 857.74365234375),
            Coord2(606.7666625976563, 851.5074462890625),
        ),
        Coord2(606.7361450195313, 853.9833984375),
    );
...
fn intersection_curve_8() {
    ...
    let loop_curve = bezier::Curve::from_points(
        Coord2(534.170654296875, 832.8574829101563),
        (
            Coord2(534.3781127929688, 832.078369140625),
            Coord2(534.73828125, 832.8485107421875),
        ),
        Coord2(534.170654296875, 832.8574829101563),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(534.3034057617188, 832.695068359375),
        (
            Coord2(534.2012536621094, 832.3760168457031),
            Coord2(534.2515673828125, 832.5331616210938),
        ),
        Coord2(534.1509399414063, 832.2188720703125),
    );
...
fn intersection_curve_9() {
    let curve1 = bezier::Curve::from_points(
        Coord2(576.0272827148438, 854.4729614257813),
        (
            Coord2(575.8976440429688, 855.9894409179688),
            Coord2(576.928466796875, 870.5877685546875),
        ),
        Coord2(577.4629516601563, 873.9253540039063),
    );
    let curve2 = bezier::Curve::from_points(
        Coord2(576.0455932617188, 854.9674072265625),
        (
            Coord2(574.2247924804688, 855.3988037109375),
            Coord2(577.3884887695313, 863.1025390625),
        ),
        Coord2(580.003662109375, 863.5904541015625),
    );
...
fn intersection_curve_10() {
    let curve1 = bezier::Curve {
        ...
        control_points: (
            Coord2(402.02495766297596, 829.2893218813454),
            Coord2(591.9744513241425, 829.2893218813454),
        ),
    };
    let curve2 = bezier::Curve {
        ...
        control_points: (
            Coord2(408.02554867585735, 829.2893218813454),
            Coord2(597.9750423370239, 829.2893218813454),
        ),
    };
...
fn intersection_very_close_to_start_1() {
    ...
    let fragment = bezier::Curve {
        start_point: Coord2(503.12144515225805, 515.6925644864517),
        end_point: Coord2(558.5270966048384, 794.2355841209692),
        control_points: (
            Coord2(521.5881487814031, 608.5309529306364),
            Coord2(540.0548524105482, 701.369341374821),
        ),
    };
    let remaining = bezier::Curve {
        start_point: Coord2(522.6328735351563, 613.7830200195313),
        end_point: Coord2(582.0244140625, 582.0244140625),
        control_points: (
            Coord2(544.3945922851563, 609.47509765625),
            Coord2(565.159912109375, 598.8888549804688),
        ),
    };
...
fn solve_t_close_to_start() {
    ...
    let t_fragment = fragment
        .t_for_point(&remaining.start_point)
        .expect("t value");
...
fn intersections_on_curve_sections() {
    ...
    let larger_curve = bezier::Curve::from_points(
        Coord2(10.0, 100.0),
        (Coord2(90.0, 30.0), Coord2(40.0, 140.0)),
        Coord2(220.0, 220.0),
    );
